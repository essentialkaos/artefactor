...
all: artefactor ## Build all binaries

artefactor:
	@echo "[36;1mBuilding artefactor…[0m"
	@go build $(VERBOSE_FLAG) -ldflags="-X main.gitrev=$(GITREV)" artefactor.go

install: ## Install all binaries
	@echo "[36;1mInstalling binaries…[0m"
	@cp artefactor /usr/bin/artefactor

uninstall: ## Uninstall all binaries
	@echo "[36;1mRemoving installed binaries…[0m"
	@rm -f /usr/bin/artefactor
